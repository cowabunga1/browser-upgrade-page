...
div.box.ff { background-image: url(./upgrade/firefox.png); }
div.box.chr_oss { background-image: url(./upgrade/chromium.png); }
div.box.chr { background-image: url(./upgrade/chrome.png); }
div.box.op { background-image: url(./upgrade/opera.png); }
div.box.ie { background-image: url(./upgrade/ie.png); }
